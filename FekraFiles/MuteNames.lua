...
if DevManial:get(Fekra.."Manial:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevManial:sadd(Fekra.."Manial:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevManial:srem(Fekra.."Manial:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevManial:del(Fekra.."Manial:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevManial:smembers(Fekra.."Manial:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevManial:get(Fekra.."Manial:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
FekraName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if FekraName then 
FekraNames = DevManial:smembers(Fekra.."Manial:Mute:Names"..msg.chat_id_) or ""
if FekraNames and FekraNames[1] then 
for i=1,#FekraNames do 
if FekraName:match("(.*)("..FekraNames[i]..")(.*)") then 
...
DevManial:set(Fekra.."Manial:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevManial:del(Fekra.."Manial:Lock:MuteNames"..msg.chat_id_)
end
end
end
